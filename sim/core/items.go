...
var Enchants = []Enchant{
	{ID: 29191, EffectID: 3002, Name: "Glyph of Power", Bonus: Stats{StatSpellPower: 22, StatSpellHit: 14}, Slot: EquipHead},
	{ID: 28909, EffectID: 2995, Name: "Greater Inscription of the Orb", Bonus: Stats{StatSpellPower: 12, StatSpellCrit: 15}, Slot: EquipShoulder},
	{ID: 28886, EffectID: 2982, Name: "Greater Inscription of Discipline", Bonus: Stats{StatSpellPower: 18, StatSpellCrit: 10}, Slot: EquipShoulder},
	{ID: 24421, EffectID: 2605, Name: "Zandalar Signet of Mojo", Bonus: Stats{StatSpellPower: 18}, Slot: EquipUnknown}, // This should no longer show up in the UI.
	{ID: 20076, EffectID: 2605, Name: "Zandalar Signet of Mojo", Bonus: Stats{StatSpellPower: 18}, Slot: EquipShoulder},
	{ID: 23545, EffectID: 2721, Name: "Power of the Scourge", Bonus: Stats{StatSpellPower: 15, StatSpellCrit: 14}, Slot: EquipShoulder},
	{ID: 27960, EffectID: 2661, Name: "Chest - Exceptional Stats", Bonus: Stats{StatStamina: 6, StatIntellect: 6, StatSpirit: 6}, Slot: EquipChest},
	{ID: 27917, EffectID: 2650, Name: "Bracer - Spellpower", Bonus: Stats{StatSpellPower: 15}, Slot: EquipUnknown}, // This should no longer show up in the UI.
	{ID: 22534, EffectID: 2650, Name: "Bracer - Spellpower", Bonus: Stats{StatSpellPower: 15}, Slot: EquipWrist},
	{ID: 33997, EffectID: 2937, Name: "Gloves - Major Spellpower", Bonus: Stats{StatSpellPower: 20}, Slot: EquipUnknown}, // This should no longer show up in the UI.
	{ID: 28272, EffectID: 2937, Name: "Gloves - Major Spellpower", Bonus: Stats{StatSpellPower: 20}, Slot: EquipHands},
	{ID: 24274, EffectID: 2748, Name: "Runic Spellthread", Bonus: Stats{StatSpellPower: 35, StatStamina: 20}, Slot: EquipLegs},
	{ID: 24273, EffectID: 2747, Name: "Mystic Spellthread", Bonus: Stats{StatSpellPower: 25, StatStamina: 15}, Slot: EquipLegs},
	{ID: 27975, EffectID: 2669, Name: "Weapon - Major Spellpower", Bonus: Stats{StatSpellPower: 40}, Slot: EquipUnknown}, // This should no longer show up in the UI.
	{ID: 22555, EffectID: 2669, Name: "Weapon - Major Spellpower", Bonus: Stats{StatSpellPower: 40}, Slot: EquipWeapon},
	{ID: 35445, EffectID: 2928, Name: "Ring - Spellpower", Bonus: Stats{StatSpellPower: 12}, Slot: EquipFinger},
	{ID: 27945, EffectID: 2654, Name: "Shield - Intellect", Bonus: Stats{StatIntellect: 12}, Slot: EquipOffhand},
}
...
const (
	...
	EquipOffhand
	EquipRanged // Ranged or Totem or Relic or Idol.
)
...
var items = []Item{
	...
	{ID: 28586, Slot: EquipHead, Name: "Wicked Witch's Hat", Phase: 1, Quality: ItemQualityEpic, SourceZone: "Kara", SourceDrop: "Opera", Stats: Stats{StatStamina: 37, StatIntellect: 38, StatSpellPower: 43, StatSpellCrit: 32}},
	...
	{ID: 29368, Slot: EquipNeck, Name: "Manasurge Pendant", Phase: 1, Quality: ItemQualityEpic, SourceZone: "Shattrah", SourceDrop: "Badges", Stats: Stats{StatStamina: 24, StatIntellect: 22, StatSpellPower: 28}},
	...
	{ID: 30079, Slot: EquipShoulder, Name: "Illidari Shoulderpads", Phase: 2, Quality: ItemQualityEpic, SourceZone: "SSC", SourceDrop: "Tidewalker", Stats: Stats{StatStamina: 34, StatIntellect: 23, StatSpellPower: 39, StatSpellCrit: 16}, GemSlots: []GemColor{GemColorYellow, GemColorYellow}, SocketBonus: Stats{StatSpellPower: 4}},
	{ID: 32338, Slot: EquipShoulder, Name: "Blood-cursed Shoulderpads", Phase: 3, Quality: ItemQualityEpic, SourceZone: "BT", SourceDrop: "Bloodboil", Stats: Stats{StatStamina: 25, StatIntellect: 19, StatSpellPower: 55, StatSpellCrit: 25, StatSpellHit: 18}},
	{ID: 30173, Slot: EquipShoulder, Name: "Cataclysm Shoulderpads (Tier 5)", Phase: 2, Quality: ItemQualityEpic, SourceZone: "TK", SourceDrop: "VoidReaver", Stats: Stats{StatStamina: 26, StatIntellect: 19, StatSpellPower: 41, StatSpellCrit: 24, StatMP5: 6}, GemSlots: []GemColor{GemColorBlue, GemColorYellow}, SocketBonus: Stats{StatSpellCrit: 3}},
	{ID: 32587, Slot: EquipShoulder, Name: "Mantle of Nimble Thought", Phase: 3, Quality: ItemQualityEpic, SourceZone: "BT", SourceDrop: "Tailoring", Stats: Stats{StatStamina: 37, StatIntellect: 26, StatSpellPower: 44, StatSpellHaste: 38}},
	{ID: 31023, Slot: EquipShoulder, Name: "Skyshatter Mantle (Tier 6)", Phase: 3, Quality: ItemQualityEpic, SourceZone: "BT", SourceDrop: "Mother", Stats: Stats{StatStamina: 30, StatIntellect: 31, StatSpellPower: 46, StatSpellCrit: 27, StatSpellHit: 11, StatMP5: 4}, GemSlots: []GemColor{GemColorBlue, GemColorYellow}, SocketBonus: Stats{StatSpellPower: 4}},
	{ID: 30884, Slot: EquipShoulder, Name: "Hatefury Mantle", Phase: 3, Quality: ItemQualityEpic, SourceZone: "Hyjal", SourceDrop: "Anetheron", Stats: Stats{StatStamina: 15, StatIntellect: 18, StatSpellPower: 55, StatSpellCrit: 24}, GemSlots: []GemColor{GemColorBlue, GemColorYellow}, SocketBonus: Stats{StatSpellCrit: 3}},
	{ID: 28766, Slot: EquipBack, Name: "Ruby Drape of the Mysticant", Phase: 1, Quality: ItemQualityEpic, SourceZone: "Kara", SourceDrop: "Prince", Stats: Stats{StatStamina: 22, StatIntellect: 21, StatSpellPower: 30, StatSpellHit: 18}},
	{ID: 28570, Slot: EquipBack, Name: "Shadow-Cloak of Dalaran", Phase: 1, Quality: ItemQualityEpic, SourceZone: "Kara", SourceDrop: "Moroes", Stats: Stats{StatStamina: 19, StatIntellect: 18, StatSpellPower: 36}},
	...
	{ID: 30056, Slot: EquipChest, Name: "Robe of Hateful Echoes", Phase: 2, Quality: ItemQualityEpic, SourceZone: "SSC", SourceDrop: "Hydross", Stats: Stats{StatStamina: 34, StatIntellect: 36, StatSpellPower: 50, StatSpellCrit: 25}, GemSlots: []GemColor{GemColorRed, GemColorYellow, GemColorYellow}, SocketBonus: Stats{StatStamina: 6}},
	{ID: 32327, Slot: EquipChest, Name: "Robe of the Shadow Council", Phase: 3, Quality: ItemQualityEpic, SourceZone: "BT", SourceDrop: "Teron", Stats: Stats{StatStamina: 37, StatIntellect: 36, StatSpellPower: 73, StatSpellCrit: 28}},
	{ID: 30913, Slot: EquipChest, Name: "Robes of Rhonin", Phase: 3, Quality: ItemQualityEpic, SourceZone: "Hyjal", SourceDrop: "Archimonde", Stats: Stats{StatStamina: 55, StatIntellect: 38, StatSpellPower: 81, StatSpellCrit: 24, StatSpellHit: 27}},
	{ID: 30169, Slot: EquipChest, Name: "Cataclysm Chestpiece (Tier 5)", Phase: 2, Quality: ItemQualityEpic, SourceZone: "TK", SourceDrop: "Kaelthas", Stats: Stats{StatStamina: 37, StatIntellect: 28, StatSpellPower: 55, StatSpellCrit: 24, StatMP5: 10}, GemSlots: []GemColor{GemColorBlue, GemColorYellow, GemColorYellow}, SocketBonus: Stats{StatSpellPower: 5}},
	{ID: 30107, Slot: EquipChest, Name: "Vestments of the Sea-Witch", Phase: 2, Quality: ItemQualityEpic, SourceZone: "SSC", SourceDrop: "LadyVashj", Stats: Stats{StatStamina: 28, StatIntellect: 28, StatSpellPower: 57, StatSpellCrit: 31, StatSpellHit: 27}, GemSlots: []GemColor{GemColorYellow, GemColorYellow, GemColorBlue}, SocketBonus: Stats{StatSpellPower: 5}},
	{ID: 32592, Slot: EquipChest, Name: "Chestguard of Relentless Storms", Phase: 3, Quality: ItemQualityEpic, SourceZone: "Hyjal", SourceDrop: "Trash", Stats: Stats{StatStamina: 36, StatIntellect: 30, StatSpellPower: 74, StatSpellCrit: 46}},
	{ID: 31017, Slot: EquipChest, Name: "Skyshatter Breastplate (Tier 6)", Phase: 3, Quality: ItemQualityEpic, SourceZone: "BT", SourceDrop: "Illidan", Stats: Stats{StatStamina: 42, StatIntellect: 41, StatSpellPower: 62, StatSpellCrit: 27, StatSpellHit: 17, StatMP5: 7}, GemSlots: []GemColor{GemColorBlue, GemColorYellow, GemColorYellow}, SocketBonus: Stats{StatSpellPower: 5}},
	{ID: 28515, Slot: EquipWrist, Name: "Bands of Nefarious Deeds", Phase: 1, Quality: ItemQualityEpic, SourceZone: "Kara", SourceDrop: "Maiden", Stats: Stats{StatStamina: 27, StatIntellect: 22, StatSpellPower: 32}},
	{ID: 32351, Slot: EquipWrist, Name: "Elunite Empowered Bracers", Phase: 3, Quality: ItemQualityEpic, SourceZone: "BT", SourceDrop: "RoS", Stats: Stats{StatStamina: 27, StatIntellect: 22, StatSpellPower: 34, StatSpellHit: 19, StatMP5: 6}},
	{ID: 32270, Slot: EquipWrist, Name: "Focused Mana Bindings", Phase: 3, Quality: ItemQualityEpic, SourceZone: "BT", SourceDrop: "Akama", Stats: Stats{StatStamina: 27, StatIntellect: 20, StatSpellPower: 42, StatSpellHit: 19}},
	{ID: 29521, Slot: EquipWrist, Name: "Netherstrike Bracers", Phase: 1, Quality: ItemQualityEpic, SourceZone: "Crafted", SourceDrop: "Leatherworking", Stats: Stats{StatStamina: 13, StatIntellect: 13, StatSpellPower: 20, StatSpellCrit: 17, StatMP5: 6}, GemSlots: []GemColor{GemColorYellow}, SocketBonus: Stats{StatSpellPower: 2}},
	{ID: 32259, Slot: EquipWrist, Name: "Bands of the Coming Storm", Phase: 3, Quality: ItemQualityEpic, SourceZone: "BT", SourceDrop: "Supremus", Stats: Stats{StatStamina: 28, StatIntellect: 28, StatSpellPower: 34, StatSpellCrit: 21}},
	{ID: 29918, Slot: EquipWrist, Name: "Mindstorm Wristbands", Phase: 2, Quality: ItemQualityEpic, SourceZone: "TK", SourceDrop: "Alar", Stats: Stats{StatStamina: 13, StatIntellect: 13, StatSpellPower: 36, StatSpellCrit: 23}},
	{ID: 30870, Slot: EquipWrist, Name: "Cuffs of Devastation", Phase: 3, Quality: ItemQualityEpic, SourceZone: "Hyjal", SourceDrop: "Winterchill", Stats: Stats{StatStamina: 22, StatIntellect: 20, StatSpellPower: 34, StatSpellCrit: 14}, GemSlots: []GemColor{GemColorYellow}, SocketBonus: Stats{StatStamina: 3}},
	{ID: 29034, Slot: EquipHands, Name: "Cyclone Handguards (Tier 4)", Phase: 1, Quality: ItemQualityEpic, SourceZone: "Kara", SourceDrop: "Curator", Stats: Stats{StatStamina: 26, StatIntellect: 29, StatSpellPower: 34, StatSpellHit: 19, StatMP5: 6}},
	...
	{ID: 28639, Slot: EquipWaist, Name: "General's Mail Girdle", Phase: 1, Quality: ItemQualityEpic, SourceZone: "PvP", SourceDrop: "PvP", Stats: Stats{StatStamina: 34, StatIntellect: 23, StatSpellPower: 28, StatSpellCrit: 23}},
	{ID: 28654, Slot: EquipWaist, Name: "Malefic Girdle", Phase: 1, Quality: ItemQualityEpic, SourceZone: "Kara", SourceDrop: "Illhoof", Stats: Stats{StatStamina: 27, StatIntellect: 26, StatSpellPower: 37, StatSpellCrit: 21}},
	{ID: 30044, Slot: EquipWaist, Name: "Monsoon Belt", Phase: 2, Quality: ItemQualityEpic, SourceZone: "SSC/TK", SourceDrop: "Leatherworking", Stats: Stats{StatStamina: 23, StatIntellect: 24, StatSpellPower: 39, StatSpellHit: 21}, GemSlots: []GemColor{GemColorBlue, GemColorYellow}, SocketBonus: Stats{StatSpellPower: 4}},
	{ID: 29520, Slot: EquipWaist, Name: "Netherstrike Belt", Phase: 1, Quality: ItemQualityEpic, SourceZone: "Crafted", SourceDrop: "Leatherworking", Stats: Stats{StatStamina: 10, StatIntellect: 17, StatSpellPower: 30, StatSpellCrit: 16, StatMP5: 9}, GemSlots: []GemColor{GemColorBlue, GemColorYellow}, SocketBonus: Stats{StatSpellCrit: 3}},
	{ID: 28799, Slot: EquipWaist, Name: "Belt of Divine Inspiration", Phase: 1, Quality: ItemQualityEpic, SourceZone: "Gruul's Lair", SourceDrop: "Maulgar", Stats: Stats{StatStamina: 27, StatIntellect: 26, StatSpellPower: 43}, GemSlots: []GemColor{GemColorYellow, GemColorBlue}, SocketBonus: Stats{StatSpellPower: 4}},
	{ID: 30064, Slot: EquipWaist, Name: "Cord of Screaming Terrors", Phase: 2, Quality: ItemQualityEpic, SourceZone: "SSC", SourceDrop: "Lurker", Stats: Stats{StatStamina: 34, StatIntellect: 15, StatSpellPower: 50, StatSpellHit: 24}, GemSlots: []GemColor{GemColorYellow, GemColorYellow}, SocketBonus: Stats{StatStamina: 4}},
	...
	{ID: 28594, Slot: EquipLegs, Name: "Trial-Fire Trousers", Phase: 1, Quality: ItemQualityEpic, SourceZone: "Kara", SourceDrop: "Opera", Stats: Stats{StatStamina: 42, StatIntellect: 40, StatSpellPower: 49}, GemSlots: []GemColor{GemColorYellow, GemColorYellow, GemColorYellow}, SocketBonus: Stats{StatSpellPower: 5}},
	{ID: 29972, Slot: EquipLegs, Name: "Trousers of the Astromancer", Phase: 2, Quality: ItemQualityEpic, SourceZone: "TK", SourceDrop: "Solarian", Stats: Stats{StatStamina: 33, StatIntellect: 36, StatSpellPower: 54}, GemSlots: []GemColor{GemColorBlue, GemColorYellow, GemColorBlue}, SocketBonus: Stats{StatSpellPower: 5}},
	...
	{ID: 28810, Slot: EquipFeet, Name: "Windshear Boots", Phase: 1, Quality: ItemQualityEpic, SourceZone: "Gruul's Lair", SourceDrop: "Gruul", Stats: Stats{StatStamina: 37, StatIntellect: 32, StatSpellPower: 39, StatSpellHit: 18}},
	{ID: 30894, Slot: EquipFeet, Name: "Blue Suede Shoes", Phase: 3, Quality: ItemQualityEpic, SourceZone: "Hyjal", SourceDrop: "Kazrogal", Stats: Stats{StatStamina: 37, StatIntellect: 32, StatSpellPower: 56, StatSpellHit: 18}},
	{ID: 30037, Slot: EquipFeet, Name: "Boots of Blasting", Phase: 2, Quality: ItemQualityEpic, SourceZone: "SSC/TK", SourceDrop: "Tailoring", Stats: Stats{StatStamina: 25, StatIntellect: 25, StatSpellPower: 39, StatSpellCrit: 25, StatSpellHit: 18}},
	{ID: 28517, Slot: EquipFeet, Name: "Boots of Foretelling", Phase: 1, Quality: ItemQualityEpic, SourceZone: "Kara", SourceDrop: "Maiden", Stats: Stats{StatStamina: 27, StatIntellect: 23, StatSpellPower: 26, StatSpellCrit: 19}, GemSlots: []GemColor{GemColorRed, GemColorYellow}, SocketBonus: Stats{StatIntellect: 3}},
	{ID: 30043, Slot: EquipFeet, Name: "Hurricane Boots", Phase: 2, Quality: ItemQualityEpic, SourceZone: "SSC/TK", SourceDrop: "Leatherworking", Stats: Stats{StatStamina: 25, StatIntellect: 26, StatSpellPower: 39, StatSpellCrit: 26, StatMP5: 6}},
	{ID: 30067, Slot: EquipFeet, Name: "Velvet Boots of the Guardian", Phase: 2, Quality: ItemQualityEpic, SourceZone: "SSC", SourceDrop: "Lurker", Stats: Stats{StatStamina: 21, StatIntellect: 21, StatSpellPower: 49, StatSpellCrit: 24}},
	{ID: 32242, Slot: EquipFeet, Name: "Boots of Oceanic Fury", Phase: 3, Quality: ItemQualityEpic, SourceZone: "BT", SourceDrop: "Najentus", Stats: Stats{StatStamina: 28, StatIntellect: 36, StatSpellPower: 55, StatSpellCrit: 26}},
	{ID: 32352, Slot: EquipFeet, Name: "Naturewarden's Treads", Phase: 3, Quality: ItemQualityEpic, SourceZone: "BT", SourceDrop: "RoS", Stats: Stats{StatStamina: 39, StatIntellect: 18, StatSpellPower: 44, StatSpellCrit: 26, StatMP5: 7}, GemSlots: []GemColor{GemColorYellow, GemColorBlue}, SocketBonus: Stats{StatSpellPower: 4}},
	{ID: 32239, Slot: EquipFeet, Name: "Slippers of the Seacaller", Phase: 3, Quality: ItemQualityEpic, SourceZone: "BT", SourceDrop: "Najentus", Stats: Stats{StatStamina: 25, StatIntellect: 18, StatSpellPower: 44, StatSpellCrit: 29}, GemSlots: []GemColor{GemColorYellow, GemColorBlue}, SocketBonus: Stats{StatSpellPower: 4}},
	{ID: 28793, Slot: EquipFinger, Name: "Band of Crimson Fury", Phase: 1, Quality: ItemQualityEpic, SourceZone: "Magtheridon's Lair", SourceDrop: "MagtheridonQuest", Stats: Stats{StatStamina: 22, StatIntellect: 22, StatSpellPower: 28, StatSpellHit: 16}},
	{ID: 28510, Slot: EquipFinger, Name: "Spectral Band of Innervation", Phase: 1, Quality: ItemQualityEpic, SourceZone: "Kara", SourceDrop: "Huntsman", Stats: Stats{StatStamina: 22, StatIntellect: 24, StatSpellPower: 29}},
	{ID: 29922, Slot: EquipFinger, Name: "Band of Al'ar", Phase: 2, Quality: ItemQualityEpic, SourceZone: "TK", SourceDrop: "Alar", Stats: Stats{StatStamina: 24, StatIntellect: 23, StatSpellPower: 37}},
	{ID: 29367, Slot: EquipFinger, Name: "Ring of Cryptic Dreams", Phase: 1, Quality: ItemQualityEpic, SourceZone: "Shattrah", SourceDrop: "Badges", Stats: Stats{StatStamina: 16, StatIntellect: 17, StatSpellPower: 23, StatSpellCrit: 20}},
	{ID: 29287, Slot: EquipFinger, Name: "Violet Signet of the Archmage", Phase: 1, Quality: ItemQualityEpic, SourceZone: "Kara", SourceDrop: "Exalted", Stats: Stats{StatStamina: 24, StatIntellect: 23, StatSpellPower: 29, StatSpellCrit: 17}},
	{ID: 29286, Slot: EquipFinger, Name: "Violet Signet (R)", Phase: 1, Quality: ItemQualityEpic, SourceZone: "Kara", SourceDrop: "Revered", Stats: Stats{StatStamina: 22, StatIntellect: 22, StatSpellPower: 28, StatSpellCrit: 17}},
	...
	{ID: 29988, Slot: EquipWeapon, SubSlot: SubslotTwoHand, Name: "The Nexus Key", Phase: 2, Quality: ItemQualityEpic, SourceZone: "TK", SourceDrop: "Kaelthas", Stats: Stats{StatStamina: 76, StatIntellect: 52, StatSpellPower: 236, StatSpellCrit: 51}},
	{ID: 32374, Slot: EquipWeapon, SubSlot: SubslotTwoHand, Name: "Zhar'doom, Greatstaff of the Devourer", Phase: 3, Quality: ItemQualityEpic, SourceZone: "BT", SourceDrop: "Illidan", Stats: Stats{StatStamina: 70, StatIntellect: 47, StatSpellPower: 259, StatSpellHaste: 55, StatSpellCrit: 36}},
	{ID: 28734, Slot: EquipOffhand, Name: "Jewel of Infinite Possibilities", Phase: 1, Quality: ItemQualityEpic, SourceZone: "Kara", SourceDrop: "Netherspite", Stats: Stats{StatStamina: 19, StatIntellect: 18, StatSpellPower: 23, StatSpellHit: 21}},
	{ID: 28611, Slot: EquipOffhand, SubSlot: SubslotShield, Name: "Dragonheart Flameshield", Phase: 1, Quality: ItemQualityEpic, SourceZone: "Kara", SourceDrop: "Nightbane", Stats: Stats{StatStamina: 19, StatIntellect: 33, StatSpellPower: 23, StatMP5: 7}},
	{ID: 34011, Slot: EquipOffhand, SubSlot: SubslotShield, Name: "Illidari Runeshield", Phase: 3, Quality: ItemQualityEpic, SourceZone: "BT", SourceDrop: "Trash", Stats: Stats{StatStamina: 45, StatIntellect: 39, StatSpellPower: 34}},
	{ID: 28781, Slot: EquipOffhand, Name: "Karaborian Talisman", Phase: 1, Quality: ItemQualityEpic, SourceZone: "Magtheridon's Lair", SourceDrop: "Magtheridon", Stats: Stats{StatStamina: 23, StatIntellect: 23, StatSpellPower: 35}},
	{ID: 29268, Slot: EquipOffhand, SubSlot: SubslotShield, Name: "Mazthoril Honor Shield", Phase: 1, Quality: ItemQualityEpic, SourceZone: "Shattrah", SourceDrop: "Badges", Stats: Stats{StatStamina: 16, StatIntellect: 17, StatSpellPower: 23, StatSpellCrit: 21}},
	{ID: 28603, Slot: EquipOffhand, Name: "Talisman of Nightbane", Phase: 1, Quality: ItemQualityEpic, SourceZone: "Kara", SourceDrop: "Nightbane", Stats: Stats{StatStamina: 19, StatIntellect: 19, StatSpellPower: 28, StatSpellCrit: 17}},
	{ID: 32361, Slot: EquipOffhand, Name: "Blind-Seers Icon", Phase: 3, Quality: ItemQualityEpic, SourceZone: "BT", SourceDrop: "Akama", Stats: Stats{StatStamina: 25, StatIntellect: 16, StatSpellPower: 42, StatSpellHit: 24}},
	{ID: 29273, Slot: EquipOffhand, Name: "Khadgar's Knapsack", Phase: 1, Quality: ItemQualityEpic, SourceZone: "Shattrah", SourceDrop: "Badges", Stats: Stats{StatSpellPower: 49}},
	{ID: 30049, Slot: EquipOffhand, Name: "FathomStone", Phase: 2, Quality: ItemQualityEpic, SourceZone: "SSC", SourceDrop: "Lurker", Stats: Stats{StatStamina: 16, StatIntellect: 12, StatSpellPower: 36, StatSpellCrit: 23}},
	{ID: 30909, Slot: EquipOffhand, SubSlot: SubslotShield, Name: "Antonidas's Aegis of Rapt Concentration", Phase: 3, Quality: ItemQualityEpic, SourceZone: "Hyjal", SourceDrop: "Archimonde", Stats: Stats{StatStamina: 28, StatIntellect: 32, StatSpellPower: 42, StatSpellCrit: 20}},
	{ID: 30872, Slot: EquipOffhand, Name: "Chronicle of Dark Secrets", Phase: 3, Quality: ItemQualityEpic, SourceZone: "Hyjal", SourceDrop: "Winterchill", Stats: Stats{StatStamina: 16, StatIntellect: 12, StatSpellPower: 42, StatSpellCrit: 23, StatSpellHit: 17}},
	{ID: 28297, Slot: EquipWeapon, Name: "Gladiator's Gavel / Gladiator's Spellblade", Phase: 1, Quality: ItemQualityEpic, SourceZone: "PvP", SourceDrop: "PvP", Stats: Stats{StatStamina: 28, StatIntellect: 18, StatSpellPower: 199}},

	// Hand Written
	{ID: 27683, Slot: EquipTrinket, Name: "Quagmirran's Eye", Phase: 1, Quality: ItemQualityRare, SourceZone: "The Slave Pens", SourceDrop: "Quagmirran", Stats: Stats{StatSpellPower: 37}, Activate: ActivateQuagsEye, ActivateCD: NeverExpires},
	{ID: 29370, Slot: EquipTrinket, Name: "Icon of the Silver Crescent", Phase: 1, Quality: ItemQualityEpic, SourceZone: "Shattrath", SourceDrop: "G'eras - 41 Badges", Stats: Stats{StatSpellPower: 43}, Activate: createSpellDmgActivate(MagicIDBlessingSilverCrescent, 155, time.Second*20), ActivateCD: time.Second * 120, CoolID: MagicIDISCTrink},
	...
	{ID: 34429, Slot: EquipTrinket, Name: "Shifting Naaru Sliver", Phase: 5, Quality: ItemQualityEpic, SourceZone: "Sunwell", SourceDrop: "", Stats: Stats{StatSpellHaste: 54}, Activate: createSpellDmgActivate(MagicIDShiftingNaaru, 320, time.Second*15), ActivateCD: time.Second * 90, CoolID: MagicIDShiftingNaaruTrink},
	{ID: 32483, Slot: EquipTrinket, Name: "The Skull of Gul'dan", Phase: 3, Quality: ItemQualityEpic, SourceZone: "Black Temple", SourceDrop: "", Stats: Stats{StatSpellHit: 25, StatSpellPower: 55}, Activate: createHasteActivate(MagicIDSkullGuldan, 175, time.Second*20), ActivateCD: time.Second * 120, CoolID: MagicIDSkullGuldanTrink},
	{ID: 33829, Slot: EquipTrinket, Name: "Hex Shrunken Head", Phase: 4, Quality: ItemQualityEpic, SourceZone: "ZA", SourceDrop: "", Stats: Stats{StatSpellPower: 53}, Activate: createSpellDmgActivate(MagicIDHexShunkHead, 211, time.Second*20), ActivateCD: time.Second * 120, CoolID: MagicIDHexTrink},
	{ID: 29376, Slot: EquipTrinket, Name: "Essence of the Martyr", Phase: 1, Quality: ItemQualityRare, SourceZone: "G'eras", SourceDrop: "Badges", Stats: Stats{StatSpellPower: 28}, Activate: createSpellDmgActivate(MagicIDSpellPower, 99, time.Second*20), ActivateCD: time.Second * 120, CoolID: MagicIDEssMartyrTrink},
	{ID: 38290, Slot: EquipTrinket, Name: "Dark Iron Smoking Pipe", Phase: 2, Quality: ItemQualityEpic, SourceZone: "Brewfest", SourceDrop: "Corin Direbrew", Stats: Stats{StatSpellPower: 43}, Activate: createSpellDmgActivate(MagicIDDarkIronPipeweed, 155, time.Second*20), ActivateCD: time.Second * 120, CoolID: MagicIDDITrink},
	...
	{ID: 29524, Slot: EquipWaist, Name: "Windhawk Belt", Phase: 1, Quality: ItemQualityEpic, SourceZone: "Leatherworking", SourceDrop: "", Stats: Stats{StatStamina: 17, StatIntellect: 19, StatSpirit: 20, StatSpellPower: 37, StatSpellCrit: 12}, GemSlots: []GemColor{GemColorBlue, GemColorYellow}, SocketBonus: Stats{StatSpellPower: 4}},
	{ID: 29523, Slot: EquipWrist, Name: "Windhawk Bracers", Phase: 1, Quality: ItemQualityEpic, SourceZone: "Leatherworking", SourceDrop: "", Stats: Stats{StatStamina: 22, StatIntellect: 17, StatSpirit: 7, StatSpellPower: 27, StatSpellCrit: 16}, GemSlots: []GemColor{GemColorYellow}, SocketBonus: Stats{StatIntellect: 2}},
	{ID: 27510, Slot: EquipHands, Name: "Tidefury Gauntlets", Phase: 1, Quality: ItemQualityRare, SourceZone: "", SourceDrop: "", Stats: Stats{StatStamina: 22, StatIntellect: 26, StatSpellPower: 29, StatMP5: 7}},
	{ID: 22730, Slot: EquipWaist, Name: "Eyestalk Waist Cord", Phase: 0, Quality: ItemQualityEpic, SourceZone: "AQ40", SourceDrop: "C'thun", Stats: Stats{StatStamina: 10, StatIntellect: 9, StatSpellPower: 41, StatSpellCrit: 14}},
	{ID: 23070, Slot: EquipLegs, Name: "Leggings of Polarity", Phase: 0, Quality: ItemQualityEpic, SourceZone: "Naxx", SourceDrop: "Thaddius", Stats: Stats{StatStamina: 20, StatIntellect: 14, StatSpellPower: 44, StatSpellCrit: 28}},
	{ID: 21709, Slot: EquipFinger, Name: "Ring of the Fallen God", Phase: 0, Quality: ItemQualityEpic, SourceZone: "AQ40", SourceDrop: "C'thun", Stats: Stats{StatStamina: 5, StatIntellect: 6, StatSpellPower: 37, StatSpellHit: 8}},
	{ID: 23031, Slot: EquipFinger, Name: "Band of the Inevitable", Phase: 0, Quality: ItemQualityEpic, SourceZone: "Naxx", SourceDrop: "Noth", Stats: Stats{StatSpellPower: 36, StatSpellHit: 8}},
	{ID: 23025, Slot: EquipFinger, Name: "Seal of the Damned", Phase: 0, Quality: ItemQualityEpic, SourceZone: "Naxx", SourceDrop: "4H", Stats: Stats{StatStamina: 17, StatSpellPower: 21, StatSpellCrit: 14, StatSpellHit: 8}},
	{ID: 23057, Slot: EquipNeck, Name: "Gem of Trapped Innocents", Phase: 0, Quality: ItemQualityEpic, SourceZone: "Naxx", SourceDrop: "KT", Stats: Stats{StatStamina: 9, StatIntellect: 7, StatSpellPower: 15, StatSpellCrit: 28}},
	{ID: 21608, Slot: EquipNeck, Name: "Amulet of Vek'nilash", Phase: 0, Quality: ItemQualityEpic, SourceZone: "AQ", SourceDrop: "Twin Emp", Stats: Stats{StatStamina: 9, StatIntellect: 5, StatSpellPower: 27, StatSpellCrit: 14}},
	...
	{ID: 28583, Slot: EquipHead, Name: "Big Bad Wolf's Head", Phase: 1, Quality: ItemQualityEpic, SourceZone: "Kara", SourceDrop: "The Big Bad Wolf", Stats: Stats{StatStamina: 42, StatIntellect: 40, StatSpellPower: 47, StatSpellCrit: 28}},
	{ID: 32586, Slot: EquipWrist, Name: "Bracers of Nimble Thought", Phase: 3, Quality: ItemQualityEpic, SourceZone: "BT", SourceDrop: "Tailoring", Stats: Stats{StatStamina: 27, StatIntellect: 20, StatSpellPower: 34, StatSpellHaste: 28}},
	{ID: 23049, Slot: EquipOffhand, Name: "Sapphiron's Left Eye", Phase: 0, Quality: ItemQualityEpic, SourceZone: "Naxx", SourceDrop: "Sapphiron", Stats: Stats{StatStamina: 12, StatIntellect: 8, StatSpellPower: 26, StatSpellCrit: 14, StatSpellHit: 8}},
	{ID: 25778, Slot: EquipWrist, Name: "Manacles of Rememberance", Phase: 1, Quality: ItemQualityUncommon, SourceZone: "Nagrand", SourceDrop: "Quest", Stats: Stats{StatSpirit: 9, StatIntellect: 10, StatSpellPower: 16, StatSpellCrit: 14}},
	{ID: 28174, Slot: EquipWrist, Name: "Shattrath Wraps", Phase: 1, Quality: ItemQualityRare, SourceZone: "Auchindoun", SourceDrop: "Quest", Stats: Stats{StatStamina: 15, StatIntellect: 15, StatSpellPower: 21}, GemSlots: []GemColor{GemColorRed}, SocketBonus: Stats{StatStamina: 3}},
	{ID: 31283, Slot: EquipWaist, Name: "Sash of Sealed Fate", Phase: 1, Quality: ItemQualityRare, SourceZone: "World Drop", SourceDrop: "BoE", Stats: Stats{StatIntellect: 15, StatSpellPower: 35, StatSpellCrit: 23}},
	{ID: 30004, Slot: EquipFeet, Name: "Landing Boots", Phase: 1, Quality: ItemQualityUncommon, SourceZone: "Netherstorm", SourceDrop: "Quest", Stats: Stats{StatStamina: 12, StatIntellect: 8, StatSpellPower: 35, StatSpellCrit: 16}},
	{ID: 31290, Slot: EquipFinger, Name: "Band of Dominion", Phase: 1, Quality: ItemQualityRare, SourceZone: "World Drop", SourceDrop: "BoE", Stats: Stats{StatSpellPower: 28, StatSpellCrit: 21}},
	...
	{ID: 32963, Slot: EquipWeapon, Name: "Merciless Gladiator's Gavel / Spellblade", Phase: 2, Quality: ItemQualityEpic, SourceZone: "PvP", SourceDrop: "", Stats: Stats{StatStamina: 27, StatIntellect: 18, StatSpellPower: 225, StatSpellHit: 15}},
	{ID: 32524, Slot: EquipBack, Name: "Shroud of the Highborne", Phase: 3, Quality: ItemQualityEpic, SourceZone: "Black Temple", SourceDrop: "Illidan Stormrage", Stats: Stats{StatStamina: 24, StatIntellect: 23, StatSpellPower: 23, StatSpellHaste: 32}},
	{ID: 33357, Slot: EquipFeet, Name: "Footpads of Madness", Phase: 4, Quality: ItemQualityEpic, SourceZone: "ZA", SourceDrop: "Jan'alai", Stats: Stats{StatStamina: 25, StatIntellect: 22, StatSpellPower: 50, StatSpellHaste: 25}},
	...
	{ID: 33354, Slot: EquipWeapon, Name: "Wub's Cursed Hexblade", Phase: 4, Quality: ItemQualityEpic, SourceZone: "ZA", SourceDrop: "", Stats: Stats{StatIntellect: 21, StatSpellPower: 217, StatSpellHit: 13, StatSpellCrit: 20, StatMP5: 6}},
	{ID: 33283, Slot: EquipWeapon, Name: "Amani Punisher", Phase: 4, Quality: ItemQualityEpic, SourceZone: "ZA", SourceDrop: "", Stats: Stats{StatStamina: 30, StatIntellect: 21, StatSpellPower: 217, StatSpellHit: 20}},
	{ID: 33466, Slot: EquipNeck, Name: "Loop of Cursed Bones", Phase: 4, Quality: ItemQualityEpic, SourceZone: "ZA", SourceDrop: "", Stats: Stats{StatStamina: 19, StatIntellect: 20, StatSpellPower: 32, StatSpellHaste: 27}},
	{ID: 33591, Slot: EquipBack, Name: "Shadowcaster's Drape", Phase: 4, Quality: ItemQualityEpic, SourceZone: "ZA", SourceDrop: "", Stats: Stats{StatStamina: 22, StatIntellect: 20, StatSpellPower: 27, StatSpellHaste: 25}},
	...
	{ID: 32792, Slot: EquipFeet, Name: "Veteran's Mail Sabatons", Phase: 2, Quality: ItemQualityEpic, SourceZone: "", SourceDrop: "", Stats: Stats{StatStamina: 39, StatIntellect: 27, StatSpellPower: 32, StatSpellCrit: 26}},
	...
	{ID: 33281, Slot: EquipNeck, Name: "Brooch of Nature's Mercy", Phase: 4, Quality: ItemQualityEpic, SourceZone: "ZA", SourceDrop: "", Stats: Stats{StatIntellect: 24, StatSpellPower: 25, StatSpellHaste: 33}},
	{ID: 33334, Slot: EquipOffhand, Name: "Fetish of the Primal Gods", Phase: 4, Quality: ItemQualityEpic, SourceZone: "ZA", SourceDrop: "", Stats: Stats{StatStamina: 24, StatIntellect: 17, StatSpellPower: 37, StatSpellHaste: 17}},
