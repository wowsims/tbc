...
var Enchants = []Enchant{
	...
	{ID: 33152, EffectID: 2564, Name: "Gloves - Superior Agility", Quality: proto.ItemQuality_ItemQualityRare, Bonus: stats.Stats{stats.Agility: 15}, ItemType: proto.ItemType_ItemTypeHands},
