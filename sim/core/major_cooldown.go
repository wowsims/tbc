...
func RegisterTemporaryStatsOnUseCD(agent Agent, auraID int32, auraName string, stat stats.Stat, amount float64, duration time.Duration, mcd MajorCooldown) {
...
func MakeTemporaryStatsOnUseCDRegistration(auraID int32, auraName string, stat stats.Stat, amount float64, duration time.Duration, mcd MajorCooldown) ApplyEffect {
