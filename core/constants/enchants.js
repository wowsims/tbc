...
enchantDescriptions.set(CHEST_EXCEPTIONAL_MANA, '+150 Mana');
export const CHEST_EXCEPTIONAL_STATS = 24003;
enchantDescriptions.set(CHEST_EXCEPTIONAL_STATS, '+6 All Stats');
export const CHEST_RESTORE_MANA_PRIME = 33991;
...
enchantDescriptions.set(GLOVES_SPELLSTRIKE, '+15 Spell Hit Rating');
export const GLOVES_STRENGTH = 33995;
enchantDescriptions.set(GLOVES_STRENGTH, '+15 Strength');
// Legs
