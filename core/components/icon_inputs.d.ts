...
export declare const DemoralizingRoar: IndividualSimIconPickerConfig<Target, number>;
export declare const DemoralizingShout: IndividualSimIconPickerConfig<Target, number>;
export declare const ThunderClap: IndividualSimIconPickerConfig<Target, number>;
export declare const InsectSwarm: IndividualSimIconPickerConfig<Target, boolean>;
export declare const ScorpidSting: IndividualSimIconPickerConfig<Target, boolean>;
export declare const ShadowEmbrace: IndividualSimIconPickerConfig<Target, boolean>;
