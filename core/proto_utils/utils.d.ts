...
export declare type RotationUnion = BalanceDruidRotation | ElementalShamanRotation | EnhancementShamanRotation | FeralDruidRotation | HunterRotation | MageRotation | RogueRotation | RetributionPaladinRotation | ProtectionPaladinRotation | ShadowPriestRotation | WarlockRotation | WarriorRotation | ProtectionWarriorRotation | SmitePriestRotation;
...
export declare type SpecProtoUnion = BalanceDruid | ElementalShaman | EnhancementShaman | FeralDruid | Hunter | Mage | Rogue | RetributionPaladin | ProtectionPaladin | ShadowPriest | Warlock | Warrior | ProtectionWarrior | SmitePriest;
