...
export declare type RotationUnion = BalanceDruidRotation | ElementalShamanRotation | EnhancementShamanRotation | HunterRotation | MageRotation | RogueRotation | RetributionPaladinRotation | ShadowPriestRotation | WarlockRotation | WarriorRotation | ProtectionWarriorRotation | SmitePriestRotation;
...
export declare type SpecOptionsUnion = BalanceDruidOptions | ElementalShamanOptions | EnhancementShamanOptions | HunterOptions | MageOptions | RogueOptions | RetributionPaladinOptions | ShadowPriestOptions | WarlockOptions | WarriorOptions | ProtectionWarriorOptions | SmitePriestOptions;
...
export declare type SpecProtoUnion = BalanceDruid | ElementalShaman | EnhancementShaman | Hunter | Mage | Rogue | RetributionPaladin | ShadowPriest | Warlock | Warrior | ProtectionWarrior | SmitePriest;
