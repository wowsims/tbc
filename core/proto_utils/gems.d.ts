...
export declare const GLINTING_NOBLE_TOPAZ = 24061;
export declare const GLINTING_PYRESTONE = 32220;
export declare const INSCRIBED_NOBLE_TOPAZ = 24058;
export declare const INSCRIBED_PYRESTONE = 32217;
...
export declare const WICKED_NOBLE_TOPAZ = 31868;
export declare const WICKED_PYRESTONE = 32222;
export declare const GLOWING_NIGHTSEYE = 24056;
export declare const GLOWING_SHADOWSONG_AMETHYST = 32215;
export declare const SHIFTING_NIGHTSEYE = 24055;
export declare const SHIFTING_SHADOWSONG_AMETHYST = 32212;
export declare const SOVEREIGN_NIGHTSEYE = 24054;
export declare const SOVEREIGN_SHADOWSONG_AMETHYST = 32211;
export declare const BOLD_CRIMSON_SPINEL = 32193;
export declare const BOLD_LIVING_RUBY = 24027;
export declare const DELICATE_CRIMSON_SPINEL = 32194;
export declare const DELICATE_LIVING_RUBY = 24028;
...
export declare const RIGID_DAWNSTONE = 24051;
export declare const RIGID_LIONSEYE = 32206;
