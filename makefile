...
$(OUT_DIR): ui_shared balance_druid elemental_shaman enhancement_shaman hunter mage rogue shadow_priest warrior protection_warrior retribution_paladin smite_priest raid
